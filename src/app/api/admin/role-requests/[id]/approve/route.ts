...
// L'attribution effective du rôle Rédacteur (EDUCATION_EDITOR + newsletter, sur l'org Yowyob
// Education) se fait à la CONNEXION SUIVANTE du candidat, via promoteToEditorOnPlatformOrg appelé
// depuis la route de login (candidature APPROVED → promotion par l'admin, owner de l'org).
